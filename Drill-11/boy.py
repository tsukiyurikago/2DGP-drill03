...
# Boy Event
RIGHT_DOWN, LEFT_DOWN, RIGHT_UP, LEFT_UP, SLEEP_TIMER, SPACE, RUN_TIMER, SHIFT_DOWN, SHIFT_UP = range(9)
...
class SleepState:
    ...
    def draw(boy):
        if boy.dir == 1:
            boy.image.clip_composite_draw(boy.frame * 100, 300, 100, 100, 3.14 / 2, ' ', boy.x - 25, boy.y - 25, 100, 100)
        else:
            boy.image.clip_composite_draw(boy.frame * 100, 200, 100, 100, -3.14 / 2, ' ', boy.x + 25, boy.y - 25, 100, 100)
...
next_state_table = {
    ...
    DashState: {RUN_TIMER: RunState, SHIFT_UP: RunState, SHIFT_DOWN: DashState, RIGHT_UP: IdleState, LEFT_UP: IdleState, LEFT_DOWN: IdleState, RIGHT_DOWN: IdleState, SPACE: DashState}
}
